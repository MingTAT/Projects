...
public class MsgDialog {
     ...
     * @return MsgDialog
     */
    public MsgDialog title(String title) {
        //如果设置了title
     ...
     * @return
     */
    public MsgDialog centerImage(String url) {
     ...
     * @return
     */
    public MsgDialog onClicklistener(DialogClickListener dialogClickListener) {
     ...
     * @return
     */
    public MsgDialog onDismisslistener(DialogDismissListener dialogDismissListener){
     ...
     * @return
     */
    public MsgDialog leftText(String text) {
     ...
     * @return
     */
    public MsgDialog rightText(String text) {
        if (!StringUtil.isEmpty(text)) {
            btn2.setText(text);
        } else {
     ...
     * @return
     */
    public MsgDialog message(String message) {
        if (!StringUtil.isEmpty(message) && messageView != null) {
    ...
    private void initNormalType(){
        ...
        messageView = (TextView) contentView.findViewById(R.id.message);//
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {// 第二个按钮事件
                if (dialogClickListener != null) {
                    dialogClickListener.rightButtonClick();
                }
                dismissDialog();
            }
        });
