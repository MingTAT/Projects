package com.healthy.healthyhelper.teacher;
...
import com.healthy.healthyhelper.teacher.apply.ApplyStudentListFragment;
...
public class TeacherActivity  extends BaseFragmentActivity{
    ...
    //导航条的title
    List<String> mDatas = Arrays.asList("申请学生列表", "学生列表","小组通知");
    ...
    protected void initView() {
        ...
        //1.加载三个页面
        mTabs.add(new ApplyStudentListFragment());
        mTabs.add(new StudentListFragment());
        mTabs.add(new SendNotificationFragment());
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if ((System.currentTimeMillis() - timeMillis) > 2000) {
                ...
                AppManager.getInstance().AppExit(TeacherActivity.this);
