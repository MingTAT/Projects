...
public class CrawlerMain {
    public static void main(String[] args) throws IOException {
        if(args.length < 2)
        {
            //rawQueryDataFile->rawQuery.txt; adsDataFile->our output; proxyFile->
        ...
        //Start reading out rawQuery file, using ","
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(rawQueryDataFilePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                //above get all information we need: bidPrice, campaignID, queryGroupID
                ...
                Thread.sleep(5000);// we do not have unlimited proxy, if keep sending requests, amazon will block proxy
            }
            bw.close();
